...
class Post(Base):
    ...
    # Links to originating post (e.g. todo created from a bug report)
    related_to: Mapped[int | None] = mapped_column(Integer, nullable=True)
    # Dependency: this post is blocked by another post (post_number reference)
